...
# We've written a SPARQL query for you and assigned it to the
# `sparql_query` variable: 
...
# Use the pre-defined SPARQL query to query dataset http://data.world/
# tutorial/sparqltutorial and return the results to a queryResults variable
