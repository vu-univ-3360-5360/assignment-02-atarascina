...
# Create two dataframes: police_shootings from the 
# 'fatal_police_shootings_data' table of int_dataset and state_abbrvs, 
# from the 'statesfipscodes' table of fipsCodes_dataset
...
merged_dataframe = police_shootings.merge(state_abbrvs, how = 'left',
left_on = 'state', right_on='stusab')

# Add a 'citystate' column to the merged_dataframe dataframe,
# populating it with the concatinated values from the 'city' and
# 'state_name' columns, separated by ', '. 
